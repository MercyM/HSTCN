...
if __name__ == '__main__':
    ...
    # algorithm = 'RNN_AGENT/offpg_smac' #dop
    # algorithm = 'Role_Learning_Agent/rode'
    # algorithm = 'Role_Learning_Agent/rode_gat'
    # algorithm = 'Role_Learning_Agent/qmix_smac_latent' #roma
    # algorithm = 'MAVEN/noisemix_smac'
    # algorithm = 'RNN_AGENT/liir_smac'
    # algorithm = 'G2ANet_Agent/qmix_beta'
    # algorithm = 'RNN_AGENT/graphmix'
    # algorithm = 'RNN_AGENT/my'
    # algorithm = 'my2/noisemix_smac'
    # algorithm = 'haven'
    algorithm = 'group'
    minigame = '3s5z'
