...
def run_sequential(args, logger):
    ...
    macro_buffer = ReplayBuffer(macro_scheme, groups, args.buffer_size,
    ...
    runner.setup(scheme=scheme, macro_scheme=macro_scheme, groups=groups, preprocess=preprocess,
                 macro_preprocess=macro_preprocess, mac=mac, macro_mac=macro_mac, value_mac=value_mac)
